...
export const TopNavBar = () => {
    return (
        <nav className='bg-white w-screen h-[60px] top-0 left-0 right-[20px] fixed shadow z-40
        flex flex-row justify-end gap-1 items-center'>
            ...
            border-[2px] border-gray-500 rounded w-[55px] h-[55px] relative'>
            ...
            mr-5 rounded w-[55px] h-[55px] relative'>
